...
DROP TABLE notice;
-- notice 테이블을 지워도 seq_notice 는 지워지지 않는다.
...
-- GENERATED ALWAYS AS IDENTITY :  db 내부적으로만 seq 생성
INSERT INTO notice (title) VALUES ('오라클');
INSERT INTO notice (title) VALUES ('수업');
INSERT INTO notice (title) VALUES ('제너레이트키');
INSERT INTO notice (title) VALUES ('ALWAYS');
-- INSERT INTO notice (notice_id,title) VALUES (5,'생성');
COMMIT;
SELECT * FROM notice;
-- db가 seq 를 생성하기 때문에 꼬임 문제에서 안전하지만 참조키 생성시 불편

CREATE TABLE notice2(
  notice_id NUMBER GENERATED BY DEFAULT ON NULL AS IDENTITY PRIMARY KEY,
  title VARCHAR2(20)
);
-- GENERATED BY DEFAULT AS IDENTITY  : 임의로 값을 줄수 있는 옵션(안전하지 않음, 참조키로 사용하기 편함)
-- GENERATED BY DEFAULT ON NULL AS IDENTITY  : DEFAULT + 값에 Null 이 있으면 seq 생성

INSERT INTO notice2 (notice_id,title) VALUES (null,'Null도 자동');
INSERT INTO notice2 (notice_id,title) VALUES (null,'Null도 자동2');
INSERT INTO notice2 (notice_id,title) VALUES (4,'임의');
INSERT INTO notice2 (title) VALUES ('자동');
-- 임의로 생성하는 값고 자동으로 만드는 값의 충돌
DELETE FROM notice2 WHERE notice_id=4;
INSERT INTO notice2 (title) VALUES ('자동');

-- 임의로 생성하는 Pk 는 자동으로 생성되는 제너레이트 키와 충돌하지 않게 조심해야함
INSERT INTO notice2 (notice_id,title) VALUES (4.001,'임의');
-- INSERT INTO notice2 (notice_id,title) VALUES (99999,'임의');
SELECT * FROM notice2;
